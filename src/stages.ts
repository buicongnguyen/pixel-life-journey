...
export const STAGES: Stage[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "candy", label: "Candy", icon: "🍬", desc: "Sweet treats. A little sugary, but a fun treat.", category: "food", effects: { fun: 8, health: -3 }, storyTag: "junkfood", treat: true },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "sweets", label: "Sweets", icon: "🍭", desc: "Lollipops and cake. A sugary little treat.", category: "food", effects: { fun: 7, health: -3 }, storyTag: "junkfood", treat: true },
